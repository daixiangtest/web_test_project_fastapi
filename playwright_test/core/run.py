        ...
        "cases": [
            {
                ...
                "steps": [
                    {"desc": "打开浏览器", "method": "open_browser", "params": {"browser_type": "chromium"}},
                    {"desc": "打开网页", "method": "open_url", "params": {"url": ".com"}},
                    {"desc": "输入搜索内容", "method": "fill_value","params": {"locator": '//*[@id="chat-textarea"]', "value": "{{value1}}"}},
                    {"desc": "点击搜索", "method": "click_elms", "params": {"locator": '//*[@id="chat-submit-button"]',"index": 1}},
                    {"desc": "等待时间", "method": "wait_time", "params": {"timeout": 30}},
